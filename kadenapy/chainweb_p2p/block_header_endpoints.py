...
For only querying blocks that are included in the winning branch of the chain the branch endpoints can be used, which return blocks in descending order starting from the leafs of branches of the block chain.
    ...
    def get_block_headers(self, chain: int, limit: int = None, next: str = None, minheight: int = None, maxheight: int = None, responseSchema: str = "object"):   
        ...
        if responseSchema == "binary":
            ...
            raise ValueError("responseScheme must be one of 'object' or 'binary'")
    ...
    def get_block_headers_by_hash(self, chain: int, blockHash: str, responseSchema: str = "object"):
    ...
    def get_block_header_branches(self, chain:int, lower:List[str], upper:List[str], limit: int = None, next: str = None, minHeight: int = None, maxHeight: int = None):
